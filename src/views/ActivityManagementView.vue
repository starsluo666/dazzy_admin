...
<template>
  <div class="page activity-page">
    <header class="page-heading activity-heading">
      <div><h1>活动列表</h1><p>审核活动内容，核对发起人资质、报名信息与发布支付</p></div>
